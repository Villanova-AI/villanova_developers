...
| Install Villanova in a local VM | [Multipass](https://multipass.run/#install)
...
>The automatic option in [Getting Started](../getting-started/) will also install the CLI along with a quickstart Villanova ACP.
