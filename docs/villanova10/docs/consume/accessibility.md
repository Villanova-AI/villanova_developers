...
# Web Accessibility in Villanova
...
or sites with a broad reach or specific governance considerations. Villanova's approach to accessibility is to provide the
...
At the end of the day, it's up to the development team to make sure their implementation is compliant with specific guidelines or standards. Typically a team will make use of Villanova Page Templates, Content Templates, and custom micro frontends in order to accomplish this goal.
...
design systems used by Villanova clients include:
