...
![Villanova Platform Development Process](./getting-started/img/concepts.png) 
...
## Create 
Building a composable application begins with self-contained bundles, created from scratch or  using existing code. With the freedom to choose the technologies and frameworks that meet their needs, developers can use the [Villanova Component Generator](./create/component-gen-overview.md) and [Blueprint](./create/blueprint-features.md) to speed up the process. The composable methods of Villanova mean innovations can be easily integrated without reworking existing systems. 

| Documentation | Tutorials        |
| :------------ | :--------- |
| [Villanova Component Generator](./create/component-gen-overview.md) | [Micro Frontends](../tutorials/create/mfe/) |
| [Villanova Blueprint Feature](./create/blueprint-features.md) | [Microservices](../tutorials/create/ms/generate-microservices-and-micro-frontends.md) |
...
| [Villanova Component Manager](./compose/ecm-overview.md) | [Content Templates](../tutorials/compose/content-templates-tutorial.md) |
...
| Documentation | Tutorials        |
| :------------ | :-------- |
| [Accessibility](./consume/accessibility.md) | [High Availability on Villanova](../tutorials/consume/high-availability.md) |
| [Villanova Operator](./consume/operator-intro.md) | [Add an API Claim](../tutorials/create/ms/add-api-claim.md) |
| [Villanova APIs](./consume/entando-apis.md) | [Invoke Villanova core APIs](../tutorials/consume/invoking-api.md) |
| [Villanova Identity Management System](./consume/identity-management.md) | [External Identity Management System](../tutorials/consume/external-id-management.md) |


## Learn More
* [Villanova Architecture](./getting-started/concepts-overview.md)
